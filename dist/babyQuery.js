...
$parcel$export(
  module.exports,
  'default',
  () => $047f9defc20f6cd7$export$2e2bcd8739ae039
)
const $d4df80a29a2554d2$var$checkers = {
   ...
   */ toType: function (input) {
    ...
    return typeof input === 'object' || typeof input === 'function'
      ? Object[Object.prototype.toString.call(input)] || 'object'
      : typeof input
  },
  /**
   ...
   */ isArrayLike: function (input) {
    ...
    var length = !!input && 'length' in input && input.length,
      type = $d4df80a29a2554d2$var$checkers.toType(input)
    if (
      $d4df80a29a2554d2$var$checkers.isFunction(input) ||
      $d4df80a29a2554d2$var$checkers.isWindow(input)
    )
      return false
    return (
      type === 'array' ||
      length === 0 ||
      (typeof length === 'number' && length > 0 && length - 1 in input)
    )
  },
  /**
   ...
   */ isPlainObject: function (input) {
    ...
    return (
      ...
      Object.prototype.toString.call(Ctor) ===
...
const {
  isArrayLike: $20b4a97a61b3fccb$var$isArrayLike,
  isEqualObject: $20b4a97a61b3fccb$var$isEqualObject,
  isPlainObject: $20b4a97a61b3fccb$var$isPlainObject
} = (0, $d4df80a29a2554d2$export$2e2bcd8739ae039)
var $20b4a97a61b3fccb$export$2e2bcd8739ae039 = {
        ...
        if (Object.prototype.hasOwnProperty.call(arguments[i], key)) {
          ...
          if (value !== undefined) {
            if (
              typeof value === 'object' &&
              value !== null &&
              !$20b4a97a61b3fccb$var$isPlainObject(value) &&
              !$20b4a97a61b3fccb$var$isArrayLike(value)
            ) {
   ...
   */ fileterDuplicateInaRow: function (array) {
    ...
    while (outerCount < array.length) {
      ...
      if ($20b4a97a61b3fccb$var$isEqualObject(value, array[innerCount]))
        while ($20b4a97a61b3fccb$var$isEqualObject(value, array[innerCount]))
          innerCount++
   ...
   */ removeDuplicates: function (array) {
    ...
    for (const item of array) {
      const isDuplicate = unique.find(obj =>
        $20b4a97a61b3fccb$var$isEqualObject(obj, item)
      )
...
const {
  isArrayLike: $8e7efde313f1b90f$var$isArrayLike,
  isBabyQueryObject: $8e7efde313f1b90f$var$isBabyQueryObject
} = (0, $d4df80a29a2554d2$export$2e2bcd8739ae039)
const {
  createHtmlElementDynamically:
    $8e7efde313f1b90f$var$createHtmlElementDynamically
} = (0, $20b4a97a61b3fccb$export$2e2bcd8739ae039)
const $8e7efde313f1b90f$var$localhelpers = {
   ...
   */ afterElemCloneHandler: function (elem, thisIndex, clonedNodeList) {
    ...
    const alreadyClonedElementInd = clonedNodeList.findIndex(ele => {
      return (
        ele.originalElement === elem && ele.contextElementIndex === thisIndex
      )
    })
    if (alreadyClonedElementInd !== -1) {
      // remove the element from the dom tree
      clonedNodeList[alreadyClonedElementInd].oldClonedElement.replaceWith(
        newClonedElement
      )
      ...
      // remove the element from the dom tree
      elem.remove()
      $8e7efde313f1b90f$var$localhelpers.insertAfterBabyqueryObject(
        elem,
        newClonedElement,
        this[thisIndex],
        thisIndex,
   ...
   * @param {} thisIndex
   * @returns
   */ inputNotFunctionorArrayForAfter: function (
    input,
    clonedNodeList,
    thisIndex
  ) {
    if (typeof input === 'string' || input instanceof HTMLElement) {
      ...
      const newElement =
        typeof input === 'string'
          ? $8e7efde313f1b90f$var$createHtmlElementDynamically(input)[0]
          : input
      clonedNodeList =
        $8e7efde313f1b90f$var$localhelpers.afterElemCloneHandler.call(
          this,
          newElement,
          thisIndex,
          clonedNodeList
        )
    } else if ($8e7efde313f1b90f$var$isArrayLike(input) && !input.nodes)
      input.reverse().forEach(ele => {
        clonedNodeList =
          $8e7efde313f1b90f$var$localhelpers.inputNotFunctionorArrayForAfter.call(
            this,
            ele,
            clonedNodeList,
            thisIndex
    ...
    else if ($8e7efde313f1b90f$var$isBabyQueryObject(input))
   ...
   */ appendElemCloneHandler: function (elem, thisIndex, clonedNodeList) {
    ...
    // remove the element from the dom tree
    elem.remove()
    $8e7efde313f1b90f$var$localhelpers.appendBabyQueryChild(
      elem,
      newClonedElement,
      this[thisIndex],
      thisIndex,
   ...
   * @param {Number} thisIndex
   *
   */ inputNotFunctionorArrayForAppend: function (
    input,
    clonedNodeList,
    thisIndex
  ) {
    if (typeof input === 'string' || input instanceof HTMLElement) {
      const newElement =
        typeof input === 'string'
          ...
          : input
      clonedNodeList =
        $8e7efde313f1b90f$var$localhelpers.appendElemCloneHandler.call(
          this,
          newElement,
          thisIndex,
          clonedNodeList
      ...
      input.forEach(ele => {
        clonedNodeList =
          $8e7efde313f1b90f$var$localhelpers.inputNotFunctionorArrayForAppend.call(
            this,
            ele,
            clonedNodeList,
            thisIndex
   ...
   *
   */ insertAfterBabyqueryObject: function (
    newNode,
    clonedNode,
    targetNode,
    elemIndex,
   ...
   */ checkHaveAnyClonedNode: function (parentNode, node) {
    ...
    parentNode.querySelectorAll('*').forEach(element => {
      if (element !== node && element.isEqualNode(node))
        ClonedElement.push(element)
    })
    return ClonedElement || false
  }
}
var $8e7efde313f1b90f$export$2e2bcd8739ae039 =
  $8e7efde313f1b90f$var$localhelpers

const {
  inputNotFunctionorArrayForAppend:
    $d8203bae9db46050$var$inputNotFunctionorArrayForAppend,
  inputNotFunctionorArrayForAfter:
    $d8203bae9db46050$var$inputNotFunctionorArrayForAfter
} = (0, $8e7efde313f1b90f$export$2e2bcd8739ae039)
const {
  isFunction: $d8203bae9db46050$var$isFunction,
  isPlainObject: $d8203bae9db46050$var$isPlainObject,
  isValidHtmlElement: $d8203bae9db46050$var$isValidHtmlElement,
  isBabyQueryObject: $d8203bae9db46050$var$isBabyQueryObject
} = (0, $d4df80a29a2554d2$export$2e2bcd8739ae039)
var $d8203bae9db46050$export$2e2bcd8739ae039 = {
    ...
    for (let index = arguments.length - 1; index >= 0; index--) {
      for (let ind = 0; ind < this.length; ind++)
        if ($d8203bae9db46050$var$isFunction(arguments[index])) {
           ...
           * Html element
           */ clonedNodeList =
            $d8203bae9db46050$var$inputNotFunctionorArrayForAfter.call(
              this,
    ...
    for (let index = 0; index < arguments.length; index++) {
      for (let ind = 0; ind < this.length; ind++)
        if ($d8203bae9db46050$var$isFunction(arguments[index])) {
           ...
           * Html element
           */ clonedNodeList =
            $d8203bae9db46050$var$inputNotFunctionorArrayForAppend.call(
              this,
              callBackReturnedValue,
              clonedNodeList,
              ind
  ...
  attr: function (name, value) {
    if (typeof name === 'string') {
      ...
      else if ($d8203bae9db46050$var$isFunction(value))
    ...
    } else if ($d8203bae9db46050$var$isPlainObject(value))
      for (let prop in value) this['0'].setAttribute(prop, value[prop])
    return this
  },
  before: function () {},
  empty: function () {},
  ...
  html: function (input) {
    ...
    for (let i = 0; i < this.length; i++) {
      if (
        typeof input === 'string' &&
        $d8203bae9db46050$var$isValidHtmlElement(input)
      )
  ...
  text: function (text) {
    if (!text) return this[0].textContent
      ...
      for (let i = 0; i < this.length; i++) this[i].textContent = text
    else if ($d8203bae9db46050$var$isFunction(text))
      for (let i = 0; i < this.length; i++)
...
const {
  separateValueUnitOperators: $a21d1168b2ad536e$var$separateValueUnitOperators
} = (0, $20b4a97a61b3fccb$export$2e2bcd8739ae039)
const $a21d1168b2ad536e$var$localhelpers = {
   ...
   */ cssValueIsFunction: function (cssProp, callback, elementArr) {
    for (let i = 0; i < elementArr.length; i++) {
      ...
      $a21d1168b2ad536e$var$localhelpers.setIncreaseDecreaseLength(
        cssProp,
        givenValue,
        elementArr[i]
      )
   ...
   */ setIncreaseDecreaseLength: function (propName, givenValue, currElement) {
    ...
    const {
      value: givenValueParsed,
      unit: givenUnitParsed,
      operator: givenOparatorParsed
    } = $a21d1168b2ad536e$var$separateValueUnitOperators(givenValue)
    givenOparatorParsed && (toIncreaseDecrease = true)
    const { value: currValue, unit: currentUnit } =
      $a21d1168b2ad536e$var$separateValueUnitOperators(
        window.getComputedStyle(currElement)[propName]
      )
    if (toIncreaseDecrease) {
      ...
      if (currentUnit === givenUnitParsed) {
        ...
        (givenUnitParsed === 'px' && currentUnit === 'rem') ||
        (givenUnitParsed === 'rem' && currentUnit === 'px')
      ) {
        const fontSize = parseFloat(getComputedStyle(currElement).fontSize)
        currValueConverted =
          $a21d1168b2ad536e$var$localhelpers.convertUnitsPxRem(
            currValue,
            currentUnit,
            givenUnitParsed,
            fontSize
      ...
      newValue =
        $a21d1168b2ad536e$var$localhelpers.increDecreLength(
          currValueConverted,
          givenValueParsed,
          givenOparatorParsed
        ) + newUnit
      ...
      currElement.style[propName] =
        givenValueParsed + (givenUnitParsed || currentUnit)
  }
}
var $a21d1168b2ad536e$export$2e2bcd8739ae039 =
  $a21d1168b2ad536e$var$localhelpers

const {
  isFunction: $a9a61dad2c314c2e$var$isFunction,
  isPlainObject: $a9a61dad2c314c2e$var$isPlainObject,
  isArrayLike: $a9a61dad2c314c2e$var$isArrayLike
} = (0, $d4df80a29a2554d2$export$2e2bcd8739ae039)
const {
  cssValueIsFunction: $a9a61dad2c314c2e$var$cssValueIsFunction,
  setIncreaseDecreaseLength: $a9a61dad2c314c2e$var$setIncreaseDecreaseLength
} = (0, $a21d1168b2ad536e$export$2e2bcd8739ae039)
    ...
    if (typeof name === 'string') {
      ...
      if (typeof value === 'string') {
        ...
        if (isValueHaveNumber)
          for (let i = 0; i < this.length; i++)
            $a9a61dad2c314c2e$var$setIncreaseDecreaseLength(
              name,
              value,
              this[i]
            )
        else if (!isValueHaveNumber)
          for (let i = 0; i < this.length; i++) this[i].style[name] = value
      } else if ($a9a61dad2c314c2e$var$isFunction(value))
        $a9a61dad2c314c2e$var$cssValueIsFunction(name, value, this)
      ...
      for (let props in name) {
        ...
        if ($a9a61dad2c314c2e$var$isFunction(name[props]))
          $a9a61dad2c314c2e$var$cssValueIsFunction(props, name[props], this)
        else
          for (let i = 0; i < this.length; i++)
...
const { isPlainObject: $6003777f4412a1bb$var$isPlainObject } =
  (0, $d4df80a29a2554d2$export$2e2bcd8739ae039)
var $6003777f4412a1bb$export$2e2bcd8739ae039 = {
   ...
   */ on: function (eventType, selector, data, callback) {
    ...
    if (!callback || !eventType)
      new Error('Must provide event type and event handler.')
    // loop over all this elements
    if ($6003777f4412a1bb$var$isPlainObject(eventType)) {
      for (let index = 0; index < this.length; index++)
        for (let items in eventType) console.log(eventType[items])
      ...
      for (let index = 0; index < events.length; index++) {
        ...
        for (let ind = 0; ind < this.length; ind++) {
          ;(this._allEventListeners[this[ind]] ??= {}) &&
            (this._allEventListeners[this[ind]][eventType] ??= [])
            ...
            if (selector) {
              if (callback === false || callback.call(this, event) === false) {
                ...
                for (let i = 0; i < selectorElements.length; i++)
                  if (
                    clickedTargetEle === this ||
                    !(
                      event.composedPath ? event.composedPath() : event.path
                    ).includes(selectorElements[i])
                  )
                    event.stopPropagation()
              }
            } else if (
          ...
          this[ind].addEventListener(
            singleEventType,
            eventListener.bind(this[ind], selector, data, callback)
          )
        }
      }
    }
  ...
  gptOne: function (eventTypes, selector, data, callback, options) {
    ...
    const delegator =
      options && options.delegator
        ? document.querySelector(options.delegator)
  ...
  gptOff: function (eventTypes, selector, callback) {
    ...
    for (let i = 0; i < selectorEventListeners.length; i++) {
      ...
      } = selectorEventListeners[i]
      if (registeredEventType === eventTypes && registeredSelector === selector)
        delegator.removeEventListener(
          eventTypes,
          selectorEventListeners[i].eventListener
        )
  ...
  gptTrigger: function (selector, eventType, eventData, options) {
    ...
    for (let i = 0; i < elements.length; i++) {
      ...
      for (const prop in eventData)
        if (eventData.hasOwnProperty(prop)) event[prop] = eventData[prop]
      // Allow triggering of native browser events
      if (
        eventType.indexOf('mouse') === 0 ||
        eventType.indexOf('click') === 0 ||
...
const {
  isValidElementSelector: $047f9defc20f6cd7$var$isValidElementSelector,
  isValidHtmlElement: $047f9defc20f6cd7$var$isValidHtmlElement,
  isPlainObject: $047f9defc20f6cd7$var$isPlainObject,
  isFunction: $047f9defc20f6cd7$var$isFunction
} = (0, $d4df80a29a2554d2$export$2e2bcd8739ae039)
const {
  createHtmlElementDynamically:
    $047f9defc20f6cd7$var$createHtmlElementDynamically,
  handleDOMReady: $047f9defc20f6cd7$var$handleDOMReady,
  myExtend: $047f9defc20f6cd7$var$myExtend
} = (0, $20b4a97a61b3fccb$export$2e2bcd8739ae039)
var $047f9defc20f6cd7$export$2e2bcd8739ae039 = (function (globalThis) {
   ...
   */ function BabyQuery (selector, context) {
    ...
    if (typeof selector === 'string') {
      ...
      if ($047f9defc20f6cd7$var$isValidElementSelector(selector))
        ...
        this.nodes =
          $047f9defc20f6cd7$var$createHtmlElementDynamically(selector)
        // HANDLE: $(html, props)
        if (context) {
          if ($047f9defc20f6cd7$var$isPlainObject(context))
      ...
      $047f9defc20f6cd7$var$handleDOMReady(selector)
    else if (selector instanceof HTMLElement) this.nodes = [selector]
  ...
  BabyQuery.fn = BabyQuery.prototype = {
     ...
     */ ready: function (callback) {
      if ($047f9defc20f6cd7$var$isFunction(callback))
        $047f9defc20f6cd7$var$handleDOMReady(callback)
    }
  }
  BabyQuery.extend = BabyQuery.fn.extend = $047f9defc20f6cd7$var$myExtend
  BabyQuery.fn.extend(
    (0, $d8203bae9db46050$export$2e2bcd8739ae039),
    (0, $a9a61dad2c314c2e$export$2e2bcd8739ae039),
    (0, $6003777f4412a1bb$export$2e2bcd8739ae039)
  )
