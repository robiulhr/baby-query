...
$parcel$export(module.exports, "default", () => $e1faf0861eb38887$export$2e2bcd8739ae039);
var $e1faf0861eb38887$var$$parcel$global = typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : typeof $parcel$global !== "undefined" ? $parcel$global : {};
const $e1faf0861eb38887$var$$d4df80a29a2554d2$var$checkers = {
    /**
  ...
  */ isArrayLike: function(input) {
        ...
        var length = !!input && "length" in input && input.length, type = $e1faf0861eb38887$var$$d4df80a29a2554d2$var$checkers.toType(input);
        if ($e1faf0861eb38887$var$$d4df80a29a2554d2$var$checkers.isFunction(input) || $e1faf0861eb38887$var$$d4df80a29a2554d2$var$checkers.isWindow(input)) return false;
  ...
  */ isPlainObject: function(input) {
        ...
        proto = Object.getPrototypeOf(input); // Objects with no prototype (e.g., `Object.create( null )`) are plain
  ...
  */ isBabyQueryObject (input) {
        return input instanceof window.$ || input instanceof $e1faf0861eb38887$var$$parcel$global.$;
    }
};
var $e1faf0861eb38887$var$$d4df80a29a2554d2$export$2e2bcd8739ae039 = $e1faf0861eb38887$var$$d4df80a29a2554d2$var$checkers;
const { isArrayLike: $e1faf0861eb38887$var$$20b4a97a61b3fccb$var$isArrayLike , isEqualObject: $e1faf0861eb38887$var$$20b4a97a61b3fccb$var$isEqualObject , isPlainObject: $e1faf0861eb38887$var$$20b4a97a61b3fccb$var$isPlainObject  } = $e1faf0861eb38887$var$$d4df80a29a2554d2$export$2e2bcd8739ae039;
var $e1faf0861eb38887$var$$20b4a97a61b3fccb$export$2e2bcd8739ae039 = {
    /**
  ...
  */ myExtend: function() {
        for(let i = 0; i < arguments.length; i++){
            ...
            for(let key in arguments[i])if (Object.prototype.hasOwnProperty.call(arguments[i], key)) {
                ...
                if (value !== undefined) {
                    if (typeof value === "object" && value !== null && !$e1faf0861eb38887$var$$20b4a97a61b3fccb$var$isPlainObject(value) && !$e1faf0861eb38887$var$$20b4a97a61b3fccb$var$isArrayLike(value)) {
  ...
  */ fileterDuplicateInaRow: function(array) {
        if (!$e1faf0861eb38887$var$$20b4a97a61b3fccb$var$isArrayLike(array)) return;
        let filteredArr = [];
        let outerCount = 0;
        while(outerCount < array.length){
            let value = array[outerCount];
            let innerCount = outerCount + 1;
            if ($e1faf0861eb38887$var$$20b4a97a61b3fccb$var$isEqualObject(value, array[innerCount])) while($e1faf0861eb38887$var$$20b4a97a61b3fccb$var$isEqualObject(value, array[innerCount]))innerCount++;
  ...
  */ removeDuplicates: function(array) {
        ...
        for (const item of array){
            const isDuplicate = unique.find((obj)=>$e1faf0861eb38887$var$$20b4a97a61b3fccb$var$isEqualObject(obj, item));
            if (!isDuplicate) unique.push(item);
        }
        return unique;
    }
};
const { isArrayLike: $e1faf0861eb38887$var$$8e7efde313f1b90f$var$isArrayLike , isBabyQueryObject: $e1faf0861eb38887$var$$8e7efde313f1b90f$var$isBabyQueryObject  } = $e1faf0861eb38887$var$$d4df80a29a2554d2$export$2e2bcd8739ae039;
const { createHtmlElementDynamically: $e1faf0861eb38887$var$$8e7efde313f1b90f$var$createHtmlElementDynamically  } = $e1faf0861eb38887$var$$20b4a97a61b3fccb$export$2e2bcd8739ae039;
const $e1faf0861eb38887$var$$8e7efde313f1b90f$var$localhelpers = {
    /**
  ...
  */ afterElemCloneHandler: function(elem, thisIndex, clonedNodeList) {
        ...
        if (alreadyClonedElementInd !== -1) {
            ...
            // remove the element from the dom tree
            elem.remove();
            $e1faf0861eb38887$var$$8e7efde313f1b90f$var$localhelpers.insertAfterBabyqueryObject(elem, newClonedElement, this[thisIndex], thisIndex, this.length);
        }
        clonedNodeList.push({
  ...
  */ inputNotFunctionorArrayForAfter: function(input, clonedNodeList, thisIndex) {
        if (typeof input === "string" || input instanceof HTMLElement) {
            ...
            const newElement = typeof input === "string" ? $e1faf0861eb38887$var$$8e7efde313f1b90f$var$createHtmlElementDynamically(input)[0] : input;
            clonedNodeList = $e1faf0861eb38887$var$$8e7efde313f1b90f$var$localhelpers.afterElemCloneHandler.call(this, newElement, thisIndex, clonedNodeList);
        } else if ($e1faf0861eb38887$var$$8e7efde313f1b90f$var$isArrayLike(input) && !input.nodes) input.reverse().forEach((ele)=>{
            clonedNodeList = $e1faf0861eb38887$var$$8e7efde313f1b90f$var$localhelpers.inputNotFunctionorArrayForAfter.call(this, ele, clonedNodeList, thisIndex);
        });
        else if ($e1faf0861eb38887$var$$8e7efde313f1b90f$var$isBabyQueryObject(input)) for(let i = input.length - 1; i >= 0; i--)clonedNodeList = $e1faf0861eb38887$var$$8e7efde313f1b90f$var$localhelpers.afterElemCloneHandler.call(this, input[i], thisIndex, clonedNodeList);
        return clonedNodeList;
    },
    /**
  * @param {HTMLElement} elem html element that need to be insert after the context element
  ...
  */ appendElemCloneHandler: function(elem, thisIndex, clonedNodeList) {
        ...
        // remove the element from the dom tree
        elem.remove();
        $e1faf0861eb38887$var$$8e7efde313f1b90f$var$localhelpers.appendBabyQueryChild(elem, newClonedElement, this[thisIndex], thisIndex, this.length);
        clonedNodeList.push({
            contextElementIndex: thisIndex,
            oldClonedElement: newClonedElement,
            originalElement: elem
  ...
  */ inputNotFunctionorArrayForAppend: function(input, clonedNodeList, thisIndex) {
        if (typeof input === "string" || input instanceof HTMLElement) {
            const newElement = typeof input === "string" ? $e1faf0861eb38887$var$$8e7efde313f1b90f$var$createHtmlElementDynamically(input)[0] : input;
            clonedNodeList = $e1faf0861eb38887$var$$8e7efde313f1b90f$var$localhelpers.appendElemCloneHandler.call(this, newElement, thisIndex, clonedNodeList);
        } else if ($e1faf0861eb38887$var$$8e7efde313f1b90f$var$isArrayLike(input) && !input.nodes) input.forEach((ele)=>{
            clonedNodeList = $e1faf0861eb38887$var$$8e7efde313f1b90f$var$localhelpers.inputNotFunctionorArrayForAppend.call(this, ele, clonedNodeList, thisIndex);
        });
        else if ($e1faf0861eb38887$var$$8e7efde313f1b90f$var$isBabyQueryObject(input)) for(let i = 0; i < input.length; i++)clonedNodeList = $e1faf0861eb38887$var$$8e7efde313f1b90f$var$localhelpers.appendElemCloneHandler.call(this, input[i], thisIndex, clonedNodeList);
        return clonedNodeList;
    },
    /**
...
var $e1faf0861eb38887$var$$8e7efde313f1b90f$export$2e2bcd8739ae039 = $e1faf0861eb38887$var$$8e7efde313f1b90f$var$localhelpers;
const { inputNotFunctionorArrayForAppend: $e1faf0861eb38887$var$$d8203bae9db46050$var$inputNotFunctionorArrayForAppend , inputNotFunctionorArrayForAfter: $e1faf0861eb38887$var$$d8203bae9db46050$var$inputNotFunctionorArrayForAfter  } = $e1faf0861eb38887$var$$8e7efde313f1b90f$export$2e2bcd8739ae039;
const { isFunction: $e1faf0861eb38887$var$$d8203bae9db46050$var$isFunction , isPlainObject: $e1faf0861eb38887$var$$d8203bae9db46050$var$isPlainObject , isValidHtmlElement: $e1faf0861eb38887$var$$d8203bae9db46050$var$isValidHtmlElement , isBabyQueryObject: $e1faf0861eb38887$var$$d8203bae9db46050$var$isBabyQueryObject  } = $e1faf0861eb38887$var$$d4df80a29a2554d2$export$2e2bcd8739ae039;
var $e1faf0861eb38887$var$$d8203bae9db46050$export$2e2bcd8739ae039 = {
    /**
  ...
  */ after: function() {
        ...
        for(let index = arguments.length - 1; index >= 0; index--){
            for(let ind = 0; ind < this.length; ind++)if ($e1faf0861eb38887$var$$d8203bae9db46050$var$isFunction(arguments[index])) {
        ...
        * array element
        * Html element
        */ clonedNodeList = $e1faf0861eb38887$var$$d8203bae9db46050$var$inputNotFunctionorArrayForAfter.call(this, callBackReturnedValue, clonedNodeList, ind);
            } else clonedNodeList = $e1faf0861eb38887$var$$d8203bae9db46050$var$inputNotFunctionorArrayForAfter.call(this, arguments[index], clonedNodeList, ind);
        }
        return this;
    },
    /**
  ...
  */ append: function() {
        ...
        * array element
        * Html element
        */ clonedNodeList = $e1faf0861eb38887$var$$d8203bae9db46050$var$inputNotFunctionorArrayForAppend.call(this, callBackReturnedValue, clonedNodeList, ind);
            } else clonedNodeList = $e1faf0861eb38887$var$$d8203bae9db46050$var$inputNotFunctionorArrayForAppend.call(this, arguments[index], clonedNodeList, ind);
        }
        return this;
    },
    /**
  ...
  */ attr: function(name, value) {
        if (typeof name === "string") {
            ...
            else if ($e1faf0861eb38887$var$$d8203bae9db46050$var$isFunction(value)) for(let i = 0; i < this.length; i++){
                const currVal = this[i]?.getAttribute(name);
                const newVal = value.call(this[i], i, currVal);
                newVal && this[i]?.setAttribute(name, newVal);
            }
        } else if ($e1faf0861eb38887$var$$d8203bae9db46050$var$isPlainObject(value)) for(let prop in value)this["0"].setAttribute(prop, value[prop]);
        return this;
    },
    before: function() {},
    empty: function() {},
  ...
  */ html: function(input) {
        ...
        for(let i = 0; i < this.length; i++){
            if (typeof input === "string" && $e1faf0861eb38887$var$$d8203bae9db46050$var$isValidHtmlElement(input)) this[i].innerHTML = input;
            else if ($e1faf0861eb38887$var$$d8203bae9db46050$var$isFunction(input)) this[i].innerHTML = input(i, this[i].innerHTML);
            else if ($e1faf0861eb38887$var$$d8203bae9db46050$var$isBabyQueryObject(input)) {
  ...
  */ text: function(text) {
        ...
        else if ($e1faf0861eb38887$var$$d8203bae9db46050$var$isFunction(text)) for(let i = 0; i < this.length; i++)this[i].textContent = text.call(this[i], i, this[i].textContent);
        return this;
    },
    toggle: function() {}
};
const { separateValueUnitOperators: $e1faf0861eb38887$var$$a21d1168b2ad536e$var$separateValueUnitOperators  } = $e1faf0861eb38887$var$$20b4a97a61b3fccb$export$2e2bcd8739ae039;
const $e1faf0861eb38887$var$$a21d1168b2ad536e$var$localhelpers = {
    /**
  ...
  */ cssValueIsFunction: function(cssProp, callback, elementArr) {
        for(let i = 0; i < elementArr.length; i++){
            ...
            $e1faf0861eb38887$var$$a21d1168b2ad536e$var$localhelpers.setIncreaseDecreaseLength(cssProp, givenValue, elementArr[i]);
        }
    },
    /**
  ...
  */ setIncreaseDecreaseLength: function(propName, givenValue, currElement) {
        ...
        const { value: givenValueParsed , unit: givenUnitParsed , operator: givenOparatorParsed  } = $e1faf0861eb38887$var$$a21d1168b2ad536e$var$separateValueUnitOperators(givenValue);
        givenOparatorParsed && (toIncreaseDecrease = true);
        const { value: currValue , unit: currentUnit  } = $e1faf0861eb38887$var$$a21d1168b2ad536e$var$separateValueUnitOperators(window.getComputedStyle(currElement)[propName]);
        if (toIncreaseDecrease) {
            ...
            if (currentUnit === givenUnitParsed) {
                ...
                currValueConverted = $e1faf0861eb38887$var$$a21d1168b2ad536e$var$localhelpers.convertUnitsPxRem(currValue, currentUnit, givenUnitParsed, fontSize);
            ...
            newValue = $e1faf0861eb38887$var$$a21d1168b2ad536e$var$localhelpers.increDecreLength(currValueConverted, givenValueParsed, givenOparatorParsed) + newUnit;
            currElement.style[propName] = newValue;
        } else currElement.style[propName] = givenValueParsed + (givenUnitParsed || currentUnit);
    }
};
var $e1faf0861eb38887$var$$a21d1168b2ad536e$export$2e2bcd8739ae039 = $e1faf0861eb38887$var$$a21d1168b2ad536e$var$localhelpers;
const { isFunction: $e1faf0861eb38887$var$$a9a61dad2c314c2e$var$isFunction , isPlainObject: $e1faf0861eb38887$var$$a9a61dad2c314c2e$var$isPlainObject , isArrayLike: $e1faf0861eb38887$var$$a9a61dad2c314c2e$var$isArrayLike  } = $e1faf0861eb38887$var$$d4df80a29a2554d2$export$2e2bcd8739ae039;
const { cssValueIsFunction: $e1faf0861eb38887$var$$a9a61dad2c314c2e$var$cssValueIsFunction , setIncreaseDecreaseLength: $e1faf0861eb38887$var$$a9a61dad2c314c2e$var$setIncreaseDecreaseLength  } = $e1faf0861eb38887$var$$a21d1168b2ad536e$export$2e2bcd8739ae039;
var $e1faf0861eb38887$var$$a9a61dad2c314c2e$export$2e2bcd8739ae039 = {
    /**
  ...
  */ css: function(name, value) {
        if (typeof name === "string") {
            ...
            if (typeof value === "string") {
                ...
                if (isValueHaveNumber) for(let i = 0; i < this.length; i++)$e1faf0861eb38887$var$$a9a61dad2c314c2e$var$setIncreaseDecreaseLength(name, value, this[i]);
                else if (!isValueHaveNumber) for(let i = 0; i < this.length; i++)this[i].style[name] = value;
            } else if ($e1faf0861eb38887$var$$a9a61dad2c314c2e$var$isFunction(value)) $e1faf0861eb38887$var$$a9a61dad2c314c2e$var$cssValueIsFunction(name, value, this);
            else if (!value) return window.getComputedStyle(this["0"])[name];
        } else if ($e1faf0861eb38887$var$$a9a61dad2c314c2e$var$isArrayLike(name)) {
            let attrs = {};
            for(let i = 0; i < name.length; i++)attrs[name[i]] = window.getComputedStyle(this["0"])[name[i]];
            return attrs;
        } else if ($e1faf0861eb38887$var$$a9a61dad2c314c2e$var$isPlainObject(name)) for(let props in name){
            // .css({"background":function,"width":function})
            if ($e1faf0861eb38887$var$$a9a61dad2c314c2e$var$isFunction(name[props])) $e1faf0861eb38887$var$$a9a61dad2c314c2e$var$cssValueIsFunction(props, name[props], this);
...
const { isFunction: $e1faf0861eb38887$var$$5d3be07a2d287b78$var$isFunction , isArrayLike: $e1faf0861eb38887$var$$5d3be07a2d287b78$var$isArrayLike  } = $e1faf0861eb38887$var$$d4df80a29a2554d2$export$2e2bcd8739ae039;
const $e1faf0861eb38887$var$$5d3be07a2d287b78$var$localhelpers = {
    /**
  ...
  */ onMethodCallbackHandler: function(event, callback) {
        ...
        if (event.__triggered && $e1faf0861eb38887$var$$5d3be07a2d287b78$var$isFunction(callback) && event.detail) return $e1faf0861eb38887$var$$5d3be07a2d287b78$var$isArrayLike(event.detail) ? callback.call(this, event, ...event.detail) : callback.call(this, event, event.detail);
        else if ($e1faf0861eb38887$var$$5d3be07a2d287b78$var$isFunction(callback)) return callback.call(this, event);
    },
    /**
        ...
        if (selector) {
            ...
            while(clickedTargetEle){
                if (clickedTargetEle.matches(selector)) {
                    ...
                    // call the callback
                    callbackReturnedValue = $e1faf0861eb38887$var$$5d3be07a2d287b78$var$localhelpers.onMethodCallbackHandler.call(selectorElm ? selectorElm : this, event, callback);
                    break;
                }
                clickedTargetEle = clickedTargetEle.parentElement;
            }
        } else // call the callback
        callbackReturnedValue = $e1faf0861eb38887$var$$5d3be07a2d287b78$var$localhelpers.onMethodCallbackHandler.call(this, event, callback);
...
var $e1faf0861eb38887$var$$5d3be07a2d287b78$export$2e2bcd8739ae039 = $e1faf0861eb38887$var$$5d3be07a2d287b78$var$localhelpers;
const { isPlainObject: $e1faf0861eb38887$var$$6003777f4412a1bb$var$isPlainObject  } = $e1faf0861eb38887$var$$d4df80a29a2554d2$export$2e2bcd8739ae039;
const { onSingleEventsMacker: $e1faf0861eb38887$var$$6003777f4412a1bb$var$onSingleEventsMacker , onEventListener: $e1faf0861eb38887$var$$6003777f4412a1bb$var$onEventListener  } = $e1faf0861eb38887$var$$5d3be07a2d287b78$export$2e2bcd8739ae039;
var $e1faf0861eb38887$var$$6003777f4412a1bb$export$2e2bcd8739ae039 = {
    /**
  * All Events Object
  */ _allEventListeners: {},
    /**
  ...
  */ on: function(eventType, selector, data, callback) {
        ...
        else if ($e1faf0861eb38887$var$$6003777f4412a1bb$var$isPlainObject(selector)) data = selector, selector = undefined;
        ...
        if ($e1faf0861eb38887$var$$6003777f4412a1bb$var$isPlainObject(eventType)) for(let item in eventType){
            const singleEvent = $e1faf0861eb38887$var$$6003777f4412a1bb$var$onSingleEventsMacker(item, selector, data, eventType[item]);
            ...
            for(let index = 0; index < this.length; index++){
                ...
                this[index].addEventListener(namespaces.length > 0 ? [
                    singleEventType,
                    ...namespaces
                ].join(".") : singleEventType, $e1faf0861eb38887$var$$6003777f4412a1bb$var$onEventListener.bind(this[index], selector, data, eventType[item]));
            }
        }
        else if (typeof eventType == "string") {
            const events = eventType.split(" ");
            for(let index = 0; index < events.length; index++){
                const singleEvent = $e1faf0861eb38887$var$$6003777f4412a1bb$var$onSingleEventsMacker(events[index], selector, data, callback);
                const { type: singleEventType , namespaces: namespaces  } = singleEvent;
                for(let ind = 0; ind < this.length; ind++){
                    ...
                    this[ind].addEventListener(namespaces.length > 0 ? [
                        singleEventType,
                        ...namespaces
                    ].join(".") : singleEventType, $e1faf0861eb38887$var$$6003777f4412a1bb$var$onEventListener.bind(this[ind], selector, data, callback));
                }
            }
        }
        return this;
  ...
  */ trigger: function(eventType, data) {
        ...
        else if ($e1faf0861eb38887$var$$6003777f4412a1bb$var$isPlainObject(eventType)) for(let index = 0; index < this.length; index++){
...
const { isValidElementSelector: $e1faf0861eb38887$var$$047f9defc20f6cd7$var$isValidElementSelector , isValidHtmlElement: $e1faf0861eb38887$var$$047f9defc20f6cd7$var$isValidHtmlElement , isPlainObject: $e1faf0861eb38887$var$$047f9defc20f6cd7$var$isPlainObject , isFunction: $e1faf0861eb38887$var$$047f9defc20f6cd7$var$isFunction  } = $e1faf0861eb38887$var$$d4df80a29a2554d2$export$2e2bcd8739ae039;
const { createHtmlElementDynamically: $e1faf0861eb38887$var$$047f9defc20f6cd7$var$createHtmlElementDynamically , handleDOMReady: $e1faf0861eb38887$var$$047f9defc20f6cd7$var$handleDOMReady , myExtend: $e1faf0861eb38887$var$$047f9defc20f6cd7$var$myExtend  } = $e1faf0861eb38887$var$$20b4a97a61b3fccb$export$2e2bcd8739ae039;
var $e1faf0861eb38887$export$2e2bcd8739ae039 = $047f9defc20f6cd7$export$2e2bcd8739ae039 = function(globalThis1) {
    /**
  ...
  */ function BabyQuery(selector, context) {
        ...
        if (typeof selector === "string") {
            ...
            if ($e1faf0861eb38887$var$$047f9defc20f6cd7$var$isValidElementSelector(selector)) // selecting all element
            this.nodes = (context || document).querySelectorAll(selector);
            else if ($e1faf0861eb38887$var$$047f9defc20f6cd7$var$isValidHtmlElement(selector)) {
                this.nodes = $e1faf0861eb38887$var$$047f9defc20f6cd7$var$createHtmlElementDynamically(selector);
                // HANDLE: $(html, props)
                if (context) {
                    if ($e1faf0861eb38887$var$$047f9defc20f6cd7$var$isPlainObject(context)) this.nodes.forEach((ele, i)=>{
                        for(let prop in context)this.attr.call(ele, prop, context[prop]);
                    });
                }
            }
        } else if (typeof selector === "function") $e1faf0861eb38887$var$$047f9defc20f6cd7$var$handleDOMReady(selector);
    ...
    */ ready: function(callback) {
            if ($e1faf0861eb38887$var$$047f9defc20f6cd7$var$isFunction(callback)) $e1faf0861eb38887$var$$047f9defc20f6cd7$var$handleDOMReady(callback);
        }
    };
    BabyQuery.extend = BabyQuery.fn.extend = $e1faf0861eb38887$var$$047f9defc20f6cd7$var$myExtend;
    BabyQuery.fn.extend($e1faf0861eb38887$var$$d8203bae9db46050$export$2e2bcd8739ae039, $e1faf0861eb38887$var$$a9a61dad2c314c2e$export$2e2bcd8739ae039, $e1faf0861eb38887$var$$6003777f4412a1bb$export$2e2bcd8739ae039);
    globalThis1.BabyQuery = globalThis1.$ = BabyQuery;
    return BabyQuery;
}("undefined" != typeof window ? window : $e1faf0861eb38887$var$$parcel$global, undefined);


//# sourceMappingURL=babyQuery.min.js.map
